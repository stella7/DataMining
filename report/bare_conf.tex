...
% in the abstract
\begin{abstract}
Abundance of movie data across the internet makes it an obvious candidate for machine learning and knowledge discovery.
\end{abstract}
...
\subsection{Data mining for the internet of things: literature review and challenges}
...
\subsection{A Case Study in a Recommender System Based on Purchase Data}
...
\subsection{Algorithms and Methods in Recommender Systems}
...
\subsection{IMDB}
The Internet Movie Database (IMDb) is a comprehensive online database having information about movies, actors, television shows, production, etc. The IMDb web site (http://www.imdb.com/ [4]) provides more than 50 text files in ad-hoc format (called lists) containing different characteristics about movies (e.g. actors.list or running-times.list). Given the large scale of the data and the degree of interactions between the people, IMDb is a fertile source of data mining problems.
